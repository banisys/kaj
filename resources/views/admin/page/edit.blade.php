                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group" style="display: block;float: left">
                                                <img v-if="form.image" :src="'/images/page/'+form.image"
        ...
        var app = new Vue({
            ...
            methods: {
                ...
                formSubmit(e) {
                    ...
                    axios.post(`/admin/page/update/${id}`, formData, config).then(function (res) {
                        swal.fire(
                            {
                ...
                fetchPage(id) {
                    ...
                    axios.get(`/admin/page/${id}`).then(res => {
                        data.page = res.data;
                        data.hhh = JSON.parse(data.page.titles);
                        data.form.name = data.page.name;
                        data.form.url = data.page.url;
                        data.form.cat = data.page.cat_id;
                        data.form.seo_title = data.page.seo_title;
                        data.form.seo_description = data.page.seo_description;
                        $('#key').tagsinput('add', data.page.seo_key);
                        data.form.image = data.page.image;
                        CKEDITOR.instances["editor1"].setData(data.page.description);
                    });
                },
                createUrl() {
