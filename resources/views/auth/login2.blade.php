...
<body>
<form method="POST" action="{{ url('/login/store') }}" ref="login" id="area">
    @csrf
    <section class="logIn2 px-0 container-fluid d-lg-flex justify-content-lg-center align-items-lg-center flex-wrap">
        <div class="col-12 col-lg-8 logIn-container d-flex flex-row flex-wrap justify-content-center px-0">
            ...
            <div class="col-12 col-lg-6 logIn-form px-5 px-lg-3 pt-0 pb-5 py-lg-0">
                ...
                <div class="col-12 px-1 px-lg-5 px-lg-6 log-in-form-log d-flex flex-row-reverse flex-wrap">
                    ...
                    <div class="col-12  px-0 pl-lg-3 mt-5" style="direction: rtl">
                        ...
                        <input v-model="login.mobile" name="mobile"
                               class="col-12 mt-2 mt-lg-0 px-0 " id="log-in-email" type="text" placeholder="شماره همراه">
                        <label for="log-in-email">شماره همراه</label>
                    </div>
                    <div class="col-12 px-0 pl-lg-3 mt-5" style="direction: rtl">
                        <span style="color: red"> @{{ error.password }} </span>
                        <input v-model="login.password" name="password"
                               class="col-12 px-0" id="log-in-pass" type="password" placeholder="رمز">
                        <label for="log-in-pass">کلمه عبور</label>
                    </div>
                    <div class="col-12 col-lg-9  px-0 px-lg-3 mt-5 mt-lg-5 mx-auto">
                        <button class="py-1 col-10 px-5 mx-auto d-block" @click.stop.prevent="loginValidation">ورود</button>
                        <p  class="mobile-login-register-txt mt-4 col-lg-10 mx-auto text-center " style="color:#777">حساب کاربری ندارید؟</p>
                        <a
                            style="background-color: #fff;color: #d73b6a;border: 2px solid #d73b6a;border-radius: 5px;padding: 7px 20px !important;transition: 0.2s;text-align: center;"
                            href="{{ url('/register') }}" class="py-1 col-10 px-5 mx-auto d-block mobile-login-register">ثبت نام</a>
                    </div>
