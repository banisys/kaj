                        ...
                        <div class="product-details-content col-12">
                            ...
                            <div class="quickview-plus-minus mt-5 mt-md-0">
                                <div class="quickview-btn-cart">
                                    <a style="color: white;cursor: pointer" class="btn-style cr-btn" v-if="!notifyMe"
                                       @click="formSubmit"><span>افزودن به سبد خرید</span></a>
                                    <a style="color: white" class="btn-style cr-btn" v-if="notifyMe"><span>در صورت موجود شدن به من اطلاع بده</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
